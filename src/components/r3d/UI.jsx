...
const PosesBox = ({ noscrollbarClass }) => {
  ...
  return (
    <div
      className={`pointer-events-auto md:rounded-t-lg bg-gradient-to-br from-black/30 to-indigo-900/20 backdrop-blur-sm drop-shadow-md flex p-6 gap-3 overflow-x-auto ${noscrollbarClass}`}
    >
...
const AssetsBox = ({ noscrollbarClass }) => {
  const {
    categories,
    currentCategory,
    setCurrentCategory,
  ...
  return (
    <div className="md:rounded-t-lg bg-gradient-to-br from-black/30 to-indigo-900/20  backdrop-blur-sm drop-shadow-md flex flex-col py-6 gap-3 overflow-hidden ">
      <div
        className={`flex items-center gap-8 pointer-events-auto overflow-x-auto px-6 pb-2 ${noscrollbarClass}`}
      >
      ...
      <div className={`flex gap-2 overflow-x-auto px-6 ${noscrollbarClass}`}>
...
export const UI = ({ noscrollbarClass }) => {
          ...
          {mode === UI_MODES.CUSTOMIZE && (
            <>
              {currentCategory?.colorPalette &&
                customization[currentCategory.name] && (
                  <ColorPicker noscrollbarClass={noscrollbarClass} />
                )}
              <AssetsBox noscrollbarClass={noscrollbarClass} />
            </>
          )}
          {mode === UI_MODES.PHOTO && (
            <PosesBox noscrollbarClass={noscrollbarClass} />
          )}
...
const ColorPicker = ({ noscrollbarClass }) => {
  ...
  return (
    <div
      className={`pointer-events-auto relative flex gap-2 max-w-full overflow-x-auto backdrop-blur-sm py-2 drop-shadow-md px-2 md:px-0 ${noscrollbarClass}`}
    >
